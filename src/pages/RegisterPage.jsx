...
function RegisterPage() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const promise = axios.post('https://local-service-backend-nqmi.onrender.com/api/auth/send-otp', { email: formData.email });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const promise = axios.post('https://local-service-backend-nqmi.onrender.com/api/auth/register', registrationData);
